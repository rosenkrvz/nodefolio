    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-3.5 mb-5 pb-4 border-b border-white/[0.06]">
          ...
          <div>
            <div className="text-[10px] font-tech text-rose-400 uppercase tracking-widest">
              Academic & Specialized Track
            </div>
            <h3 className="font-display text-xl text-white font-normal tracking-wide mt-0.5">
              {certificate.title}
            </h3>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3 mb-5">
          <div className="p-3 rounded-lg bg-white/[0.02] border border-white/[0.05]">
            <div className="flex items-center gap-1.5 text-xs font-tech text-zinc-500 mb-1">
              <Building className="w-3.5 h-3.5" />
              <span>Program / Institution</span>
            </div>
            <div className="text-xs font-body font-semibold text-zinc-200">{certificate.issuer}</div>
          </div>
          ...
          <div className="p-3 rounded-lg bg-white/[0.02] border border-white/[0.05]">
            ...
            <div className="text-xs font-body font-semibold text-zinc-200">
        ...
        <div className="space-y-2 mb-5">
          ...
          <div className="flex flex-wrap gap-1.5">
            {certificate.skills.map((skill) => (
              <span
                key={skill}
                className="px-2.5 py-1 rounded text-xs font-tech bg-rose-950/40 text-rose-300 border border-rose-500/20"
              >
                {skill}
              </span>
            ))}
        ...
        <div className="flex items-center gap-3 pt-3 border-t border-white/[0.06]">
          ...
          <button
            type="button"
            onClick={onClose}
            className="py-2.5 px-4 rounded-xl bg-white/[0.04] hover:bg-white/[0.08] text-zinc-400 font-body text-xs transition-colors"
          >
            Close
          </button>
        </div>
