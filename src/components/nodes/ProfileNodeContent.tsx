...
export const ProfileNodeContent: React.FC<ProfileNodeContentProps> = ({
  ...
  return (
    <div className="space-y-3 pt-0.5 text-zinc-300">
      <div>
        <div className="text-[10px] font-tech text-rose-500/90 tracking-widest uppercase mb-1">
          Identity Anchor
        </div>
        <h4 className="font-display text-lg text-white font-normal tracking-wide">
          {data.name}
        </h4>
        <p className="text-xs font-body text-zinc-400 font-medium mt-0.5">
          {data.role}
        </p>
      </div>
      ...
      <div className="pt-2 flex items-center justify-between border-t border-white/[0.06]">
        ...
        <button
          ...
          className="text-[11px] font-body text-zinc-400 hover:text-zinc-200 transition-colors"
        >
          View CV
        </button>
      </div>
